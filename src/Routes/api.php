...
use Creatify\Authentication\Http\Controllers\API\AuthenticationController;
use Illuminate\Support\Facades\Route;
use  Creatify\Authentication\Http\Controllers\API\ForgetPasswordController;
use  Creatify\Authentication\Http\Controllers\API\ChangePasswordController;
use  Creatify\Authentication\Http\Controllers\API\PersonalInfoController;
